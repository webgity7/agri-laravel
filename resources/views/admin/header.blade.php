    ...
    <div class="app-wrapper">
        ...
        <nav class="app-header navbar navbar-expand bg-body" style="background-color:#80c908;">
            <div class="container-fluid">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" data-lte-toggle="sidebar" href="#"><i
                                class="text-white fs-5 bi bi-list"></i></a>
                    </li>
                </ul>
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item d-flex">
                        <a href="{{ url('/') }}" class="nav-link"><span class="text-white fw-bold">Go to
                                site</span></a>
                        <a href="{{('admin/logout')}}" class="nav-link"><span class="text-white fw-bold">Log
                                Out</span></a>
                    </li>
                </ul>
            </div>
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            <div class="sidebar-brand" style="background-color:#80c908;">
                <a href="#" class="brand-link">
                    <img src="{{ asset('images/user.png') }}" class="rounded-circle shadow" alt="User Image">
                ...
                <nav class="mt-2">
                    <ul class="nav sidebar-menu" data-lte-toggle="treeview" role="navigation" data-accordion="false">
                        <li class="nav-item"><a href="{{route('admin.dashboard')}} " class="nav-link"><i
                                    class="nav-icon bi bi-speedometer text-white"></i>
                                <p class="text-white">Dashboard</p>
                            </a></li>
                        <li class="nav-item"><a href="{{route('admin.category')}}" class="nav-link"><i
                                    class="nav-icon bi bi-ui-checks-grid text-white"></i>
                                <p class="text-white">Category</p>
                            </a></li>
                        <li class="nav-item"><a href="{{route('admin.subcategory')}}" class="nav-link"><i
                                    class="nav-icon bi bi-grid-fill text-white"></i>
                                <p class="text-white">Sub Category</p>
                            </a></li>
                        <li class="nav-item"><a href="{{route('admin.product')}}" class="nav-link"><i
                                    class="nav-icon bi bi-box text-white"></i>
                                <p class="text-white">Product</p>
                            </a></li>
                        <li class="nav-item"><a href="{{route('admin.order')}}" class="nav-link"><i
                                    class="nav-icon bi bi-cart3 text-white"></i>
                                <p class="text-white">Order</p>
                            </a></li>
                        <li class="nav-item"><a href="{{route('admin.discount')}}" class="nav-link"><i
                                    class="nav-icon bi bi-percent text-white"></i>
                                <p class="text-white">Discount</p>
                            </a></li>
                        <li class="nav-item"><a href="{{route('admin.customer')}} " class="nav-link"><i
                                    class="nav-icon bi bi-person text-white"></i>
                                <p class="text-white">Customer</p>
                            </a></li>
                        <li class="nav-item"><a href="{{route('admin.settings')}}" class="nav-link"><i
                                    class="nav-icon bi bi-gear-wide text-white"></i>
