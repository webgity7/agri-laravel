...
<main class="app-main" id="main" tabindex="-1">
    ...
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0"><? echo !empty($subcategory_id) ? 'Edit' : 'Add'; ?> Sub Category</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="dashboard.">Home</a></li>
                        <li class="breadcrumb-item"><a href="sub_category.">Sub Category</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><? echo !empty($subcategory_id) ? 'Edit' : 'Add'; ?> Sub Category</li>
                    </ol>
                </div>
            </div>
            <!--end::Row-->
            ...
            <div class="row">
                ...
                <div class="card card-primary card-outline mb-4">
                    ...
                    <div class="card-header">
                        <div class="card-title"><? echo !empty($subcategory_id) ? 'Edit' : 'Add'; ?> Sub Category</div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Form-->
                    <?
                    ...
                    <form id="image_form" action="<? $action_url ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-footer text-center d-flex justify-content-center gap-4">
                            <button type="submit" class="btn btn-success text-white"><? echo !empty($subcategory_id) ? 'Update' : 'Add'; ?></button>
