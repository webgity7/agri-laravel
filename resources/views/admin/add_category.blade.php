...
<main class="app-main" id="main" tabindex="-1">
    ...
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0"><? echo isset($category_id) ? 'Edit' : 'Add'; ?> Category</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="dashboard">Home</a></li>
                        <li class="breadcrumb-item"><a href="category">Category</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><? echo isset($category_id) ? 'Edit' : 'Add'; ?> Category</li>
                    </ol>
                </div>
            </div>
            <!--end::Row-->
            ...
            <div class="row">
                ...
                <div class="card card-primary card-outline mb-4">
                    ...
                    <div class="card-header">
                        <div class="card-title"><? echo isset($category_id) ? 'Edit' : 'Add'; ?> Category</div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Form-->
                    <?
                    ...
                    <form id="addCategory" action="<? $action_url ?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="category_id" value="<? echo !empty($category_id) ? $category_id : ''; ?>">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:10px;">
                                        <div class="image_item_parent mb-2  gap-2 ">
                                            <div class="image_item"><img src="<? ('uploads/category_images/') . $category['image'] ?>" alt=""></div>
                                        </div>
                        ...
                        <div class="card-footer text-center d-flex justify-content-center gap-4">
                            <button type="submit" class="btn btn-success text-white"><? echo isset($category_id) ? 'Update' : 'Add'; ?></button>
